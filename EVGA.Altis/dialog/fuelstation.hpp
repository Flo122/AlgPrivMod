class fuelstation_Dialog {
	...
	class controls
	{
		class VehicleList : Life_RscListBox
		{
			...
			onLBSelChanged = "[_this] call EVGA_fnc_fuelStationSelect;";
		...
		class sliderAmount : life_RscXSliderH 
		{
			idc = 29012;
			text = "";
			onSliderPosChanged = "[_this] call EVGA_fnc_fuelStationSliderChange;";
		...
		class btnRefillVehicle : Life_RscButtonMenu
		{
			...
			onButtonClick = "[] spawn EVGA_fnc_fuelstationFill;";
