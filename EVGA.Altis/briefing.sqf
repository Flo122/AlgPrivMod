...
player createDiarySubject ["close","Schlusswort"];
	...
	player createDiaryRecord["foreword",
		[
			"Donator",
				"
				Wir haben auf unserem Server ein Donator-System. Der Donator-Status gilt jeweils fuer einen Monat und ist nach Bezahlung eines Mindestbetrages von 10 Euro verfuegbar. Zahlungen im Voraus werden nicht akzeptiert.<br/>
	...
	player createDiaryRecord["foreword",
		[
			"Changelog",
				"
				Added Infistar Anti Cheat<br/>
				Tank system Added<br/>
				Maskier System Added <br/>
	...
	player createDiaryRecord["foreword",
		[
			"Daten",
				"
				- Filter: Eventus Gaming Germany<br/>
				- IP: 85.10.211.163<br/>
				- TS: eventusgaming.com<br/>
				- Homepage: www.eventusgaming.com<br/>
				- Forum: http://forum.eventusgaming.com<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["serverrules",
		[
			"§5 New Life Regel",
				...
				Beginnt ein neues Leben, sind alle vorherigen Straftaten, Drohungen etc. vergessen.<br/>
				...
				Liegt die Spielerzahl der Polizei bei unter 6, und das Geschehen hat sich nicht zum Großteil aufgelöst, darf die Polizei nach 15 Minuten wieder ins Geschehen eingreifen.<br/>
				...
				- Eine Wiederbelebung durch einen Sanitäter <br/>
	...
	player createDiaryRecord["close",
		[
			"Links",
				...
				Eventus Gaming: www.eventusgaming.de<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["close",
		[
			"Schlusswort",
				"
					Trotz der vielen Regeln und Gebote, die leider unabdingbar sind, um den Spielspass zu erhalten, sind wir auch nur Menschen. Wenn ihr also Zweifel habt, ob etwas richtig abgelaufen ist oder wenn ihr Verbesserungsvorschlaege habt, zoegert bitte nicht, uns entweder im TS oder InGame anzusprechen und im Supportbereich zu warten, damit wir uns so schnell wie moeglich um euer Anliegen kuemmern koennen. Solltet ihr Fragen das Spiel betreffend haben, koennte euch auch der im TS vorhandene FAQ-Channel in der Eingangshalle helfen. Team - eventusgaming.<br/><br/>
				"
		]
	];
