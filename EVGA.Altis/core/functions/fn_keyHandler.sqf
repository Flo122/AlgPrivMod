...
switch (_code) do
{
	...
	case 38: 
	{
		...
		if(_shift && playerSide in [west,independent]) then {
			if(vehicle player != player && (typeOf vehicle player) in ["I_MRAP_03_F","B_MRAP_01_hmg_F","B_Quadbike_01_F","I_Heli_Transport_02_F","C_Offroad_01_F","C_Offroad_01_repair_F","B_G_Offroad_01_repair_F","B_Truck_01_mover_F","B_MRAP_01_F","C_SUV_01_F","C_Van_01_box_F","B_MRAP_01_HMG_F","C_Hatchback_01_sport_F","C_Hatchback_01_F","B_Heli_Light_01_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_01_F","I_Heli_light_03_unarmed_F"]) then {
    ...
    {    if(!_shift) then
            {
                if(playerSide in [west,independent] && !life_siren2_active && ((driver vehicle player) == player) && (typeOf vehicle player) in ["I_MRAP_03_F","B_MRAP_01_hmg_F","B_Quadbike_01_F","I_Heli_Transport_02_F","C_Offroad_01_F","B_G_Offroad_01_repair_F","B_MRAP_01_F","C_SUV_01_F","C_Van_01_box_F","B_MRAP_01_HMG_F","C_Hatchback_01_sport_F","C_Hatchback_01_F","B_Heli_Light_01_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_01_F","I_Heli_light_03_unarmed_F","O_Heli_Transport_04_F","O_Heli_Transport_04_medevac_F","I_Heli_Transport_02_F","B_Heli_Transport_03_unarmed_F","B_Lifeboat","C_Boat_Civil_01_police_F","B_Boat_Armed_01_minigun_F","B_SDV_01_F"]) then
                {
                    [] spawn
                    {
