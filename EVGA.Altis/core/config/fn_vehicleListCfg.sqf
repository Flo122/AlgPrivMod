...
switch (_shop) do
{
	...
	case "civ_truck":
	{
		...
		[
			...
			["O_Truck_02_fuel_F",470000],			
			["O_Truck_03_transport_F",550000],
			["O_Truck_03_covered_F",650000],
			["O_Truck_03_fuel_F",560000],
			["O_Truck_03_device_F",7000000],
			["B_Truck_01_transport_F",3000000],
			["B_Truck_01_covered_F",3000000],
			["B_Truck_01_fuel_F",2700000],
	...
	case "reb_car":
	{
		...
		{
			_return pushBack
			["B_G_Offroad_01_armed_F",9700000];
		};
	};
