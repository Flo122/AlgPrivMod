/*
	...
	Description:
	Adds an single light effect to assistant and medic vehicles.
*/
...
if(typeOf _vehicle in ["C_Offroad_01_repair_F","B_Truck_01_mover_F"]) then {
	_lightBlue = [255, 209, 1];
} else {
...
switch (typeOf _vehicle) do
{
	...
	{
		_light lightAttachObject [_vehicle, [0.0, 2.05, 0.55]];
	};
