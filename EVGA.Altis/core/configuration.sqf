...
//Gang related stuff?
__CONST__(life_gangPrice,3000000); //Price for creating a gang (They're all persistent so keep it high to avoid 345345345 gangs).
...
/*
*****************************
****** Array List add Items that mask u into it *******
*****************************
*/
EVGA_goggles_Array = ["G_Balaclava_blk","G_Balaclava_combat","G_Balaclava_lowprofile","G_Bandanna_blk","G_Balaclava_oli","G_Bandanna_aviator","G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_shades","G_Bandanna_sport","G_Bandanna_tan","G_Bandanna_shades","G_Bandanna_beast","G_Balaclava_blk"];
EVGA_uniform_Array = ["U_O_GhillieSuit","U_B_GhillieSuit","U_I_GhillieSuit"];
EVGA_headgear_Array = ["H_Shemag_olive","H_Shemag_khk","H_Shemag_tan","H_Shemag_olive_hs","H_ShemagOpen_khk","H_ShemagOpen_tan","H_Bandanna_camo","H_CrewHelmetHeli_I","H_CrewHelmetHeli_B"];
/*
*****************************
****** Life Variables *******
*****************************
...
switch (playerSide) do
{
	case west: 
	{
		life_atmcash_pirates = 20000; //Starting Bank Money
		life_paycheck = 1900;
	};
	case civilian: 
	{
		life_atmcash_pirates = 20000; //Starting Bank Money
		life_paycheck = 1400; //Paycheck Amount
	};
	
	case independent:
	{
		life_atmcash_pirates = 16000;
		life_paycheck = 3500;
	};
